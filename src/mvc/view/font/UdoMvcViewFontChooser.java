 ...
 * <pre>
 **/
public class UdoMvcViewFontChooser extends JComponent
{
    // class variables
    /**
     ...
     **/
    public UdoMvcViewFontChooser()
    {
        this(DEFAULT_FONT_SIZE_STRINGS);
    }

    public UdoMvcViewFontChooser(boolean sample)
    {
        this(DEFAULT_FONT_SIZE_STRINGS,sample);
    }

    public UdoMvcViewFontChooser(String[] fontSizeStrings)
    {
    	this(fontSizeStrings,true);
    }
     ...
     **/
    public UdoMvcViewFontChooser(String[] fontSizeStrings, boolean sample)
    {
